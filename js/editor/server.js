...
// html request
function send_html_request(type, str, callback, body) {
...
send_html_request('GET', "https://ks29sd5rn3.execute-api.us-east-1.amazonaws.com/staging/task", (json) => {
