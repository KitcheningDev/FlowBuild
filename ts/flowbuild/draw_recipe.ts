...
import { add_sync_lines, reserve_sync_lines } from "./collapse/post_process/add_sync_lines.js";
import { local_center } from "./collapse/post_process/center_nodes.js";
...
export function draw_recipe(recipe: Recipe): void {
    ...
    reserve_sync_lines(flow_grid, graph);
    // local_center(flow_grid, metric_grid, graph, create_rules(graph, false));
    graph.unflatten();
