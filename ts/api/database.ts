import { Recipe } from "../flowbuild/recipe/recipe";
import { Task } from "../flowbuild/recipe/task";
...
export function send_html_request(type: string, str: string, body?: any): void {
...
function add_task(task: Task, recipe_key: string): string {
...
function add_connection(from_id: string, to_id: string): string {
...
function add_recipe(recipe: Recipe): string {
    ...
    const task_key_map = new Map<Task, string>();
